  ...
  <body>
    <div class="header-container">
      <header class="wrapper clearfix">
        ...
        <h2 class="title">Presentation - Demonstration - Documentation</h2>
      </header>
    </div>
    ...
    <div class="main-container">
      <header>
        <p>
          Here will be every presentation of HLS with schema
        </p>
      </header>
      <div id="controls">
      <div style="display: none" class="config-editor-container">
            <div id="config-editor">Loading...</div>
          </div>
        <div class="demo-controls-wrapper">
          <select id="streamSelect" class="innerControls">
            <?php if ($_GET['selected']== 'live') {
              echo '<option value="Live Test" selected>Select a test-stream from drop-down menu. Or enter custom URL
              below</option>';
            }
            else {
              echo '<option value="" selected>Select a test-stream from drop-down menu. Or enter custom URL
              below</option>';
            }
            ?>
          </select>
